...
use currency::{CurrencyDTO, CurrencyDef, Group, GroupFilterMap, MemberOf};
...
impl<GBalances, CmdBalances> GroupFilterMap for NonZeroBalances<'_, '_, GBalances, CmdBalances>
where
    GBalances: Group,
