...
use crate::{CurrencyDTO, CurrencyDef, Group, GroupFindMap, Matcher, MemberOf, PairsGroup};
...
impl<MatcherImpl, TargetG> GroupFindMap for FindCurrencyBySymbol<MatcherImpl, TargetG>
where
    MatcherImpl: Matcher,
    TargetG: Group,
{
