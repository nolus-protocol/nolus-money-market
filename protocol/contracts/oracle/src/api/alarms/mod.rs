...
mod test {
    ...
    use currencies::{
        test::{PaymentC5, PaymentC6, PaymentC7, StableC1 as Lpn},
        PaymentGroup,
    };
    use currency::{Currency, Group};
    use finance::{
    ...
    #[test]
    fn below_price_ok() {
        let exp_price = price::total_of(Coin::<PaymentC6>::new(10)).is(Coin::<Lpn>::new(10));
    ...
    fn currencies_mismatch() {
        let below = price::total_of(Coin::<PaymentC7>::new(2)).is(Coin::<Lpn>::new(10));
        let above = price::total_of(Coin::<PaymentC6>::new(2)).is(Coin::<Lpn>::new(10));
    ...
    fn below_not_less_than_above() {
        let below = price::total_of(Coin::<PaymentC6>::new(2)).is(Coin::<Lpn>::new(10));
        let above = price::total_of(Coin::<PaymentC6>::new(2)).is(Coin::<Lpn>::new(9));
    ...
    fn below_price_eq_above() {
        let price = price::total_of(Coin::<PaymentC7>::new(1)).is(Coin::<Lpn>::new(10));
    ...
    fn below_price_less_than_above() {
        let price_below = price::total_of(Coin::<PaymentC7>::new(1)).is(Coin::<Lpn>::new(10));
        let price_above_or_equal =
            price::total_of(Coin::<PaymentC7>::new(1)).is(Coin::<Lpn>::new(11));
