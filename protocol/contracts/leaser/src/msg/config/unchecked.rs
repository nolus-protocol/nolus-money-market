...
mod test {
    ...
    fn read_valid() {
        ...
        let max_slippages = MaxSlippages {
            liquidation: MaxSlippage::new(Percent100::from_permille(200)), // (100%-20%) of 10 LPN = 8 LPN != 0 LPN
        };
    ...
    fn read_invalid() {
        ...
        let max_slippages = MaxSlippages {
            liquidation: MaxSlippage::new(Percent100::from_percent(91)), //(100%-91%) of 10 LPN = 0.9 LPN == 0 LPN
        };
