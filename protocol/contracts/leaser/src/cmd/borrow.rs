    ...
    pub(crate) fn open_lease_msg(
        ...
        NewLeaseContract {
            form: NewLeaseForm {
                ...
                currency,
                max_ltd,
                position_spec: config.lease_config.position_spec,
                loan: LoanForm {
                    lpp: config.lpp,
                    profit: config.profit,
                    annual_margin_interest: config.lease_config.interest_rate_margin,
                    due_period: config.lease_config.due_period,
                },
