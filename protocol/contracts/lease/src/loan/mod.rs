...
mod tests {
    ...
    mod test_repay {
        ...
        use crate::{
            ...
            loan::{
                ...
                tests::{coin, create_loan_custom, profit_stub, PROFIT_ADDR},
                Loan, Overdue, State,
            },
        };
            ...
            let mut loan = create_loan(loan);
            {
                ...
                repay(
                    ...
                    state(
                        ...
                        one_year_interest,
                        Overdue::Accrued {
                            interest: coin(one_year_interest),
                            margin: coin(one_year_margin),
                        },
                    ),
...

            {
                ...
                repay(
                    ...
                    state(
                        ...
                        one_year_interest,
                        Overdue::Accrued {
                            interest: coin(delta_to_fully_paid),
                            margin: coin(one_year_margin),
                        },
                    ),
                    receipt(
        ...
        fn partial_max_due_margin_repay() {
            ...
            repay(
                ...
                Duration::YEAR.into_slice_per_ratio(coin(payment), coin(due_margin)),
                &now,
            );
        }
            ...
            let mut loan = create_loan(loan);
            {
                ...
                repay(
                    ...
                    state(
                        ...
                        one_year_interest,
                        Overdue::Accrued {
                            interest: coin(overdue_interest),
                            margin: coin(overdue_margin),
                        },
                    ),
            ...
            let mut loan = create_loan(loan);
            {
                ...
                repay(
                    ...
                    state(
                        ...
                        one_year_interest,
                        Overdue::Accrued {
                            interest: coin(one_year_interest * 2 + overdue_interest_modulo_year),
                            margin: coin(one_year_margin * 2 + overdue_margin_modulo_year),
                        },
                    ),
            ...
            }
            {
                ...
                repay(
                    ...
                    state(
                        ...
                        one_year_interest,
                        Overdue::Accrued {
                            interest: coin(overdue_interest_modulo_year - interest_payment),
                            margin: coin(one_year_margin * 2 + overdue_margin_modulo_year),
                        },
                    ),
                    receipt(
        ...
        fn full_max_overdue_full_due_repay() {
            ...
            let due_period_paid =
                Duration::between(&LEASE_START, &repay_at).into_slice_per_ratio::<LpnCoin>(
                    coin(overdue_margin + due_margin_payment),
                    coin(overdue_margin + due_margin),
                ) - overdue_period;
        ...
        fn repay(
            ...
            assert_eq!(Ok(exp_receipt), loan.repay(coin(payment), now, &mut profit));
            assert_eq!(
        ...
        fn state_custom_percents(
            ...
            State {
                ...
                principal_due: coin(principal),
                due_margin_interest: coin(due_margin_interest),
                due_interest: coin(due_interest),
                overdue,
            }
        }
        ...
        fn receipt(
            ...
            RepayReceipt::new(
                coin(paid_overdue_interest),
                coin(paid_overdue_margin),
                coin(paid_due_interest),
                coin(paid_due_margin),
                coin(principal),
                coin(paid_principal),
                coin(change),
            )
    ...
    mod test_state {
        ...
        use crate::loan::{
            tests::{coin, create_loan_custom, LppLoanLocal},
            Overdue, State,
        };
