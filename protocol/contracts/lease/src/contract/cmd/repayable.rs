    ...
    EmitterT: Emitter,
{
    ...
    where
        ...
        Oracle: OracleTrait<LeasePaymentCurrencies, QuoteC = LpnCurrency, QuoteG = LpnCurrencies>,
    {
        Self::do_check_close(lease, now, time_alarm, price_alarm).and_then(|close_status| {
            ...
            if matches!(
                ...
                lease
                    ...
                    .and_then(|()| Self::do_check_close(lease, now, time_alarm, price_alarm))
            } else {
                Ok(close_status)
            }
        })
    ...
    fn do_check_close<'time_alarm, Asset, Lpp, Oracle>(
    ...
    where
        ...
        Oracle: OracleTrait<LeasePaymentCurrencies, QuoteC = LpnCurrency, QuoteG = LpnCurrencies>,
    {
        check_close::check_close(lease, now, &time_alarm, &price_alarm)
    }
}
