...
const HALF_STEP: Percent = Percent100::from_permille(5);
const STEP: Percent = Percent100::from_permille(5 + 5);
const MAX_DEBT: Percent = Percent100::from_permille(800);
...
mod test_debt {
    ...
    use crate::position::{spec::test::STEP, Cause, Debt};
