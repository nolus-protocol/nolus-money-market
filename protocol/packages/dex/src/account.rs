...
impl Account {
    ...
    pub fn ics20_channel_local(&self) -> &str {
        &self.ics20_channel_local
    }
}
...
mod test {
    ...
    fn new_serializes_expected_wire_shape() {
        assert_eq!(
            r#"{"owner":"owner-contract","remote":"remote-account","remote_controller":"remote-lease-controller","ics20_channel_local":"channel-0"}"#,
