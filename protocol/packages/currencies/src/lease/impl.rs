    ...
    V: PairsVisitor<Pivot = PaymentGroup, VisitedG = PaymentGroup>,
{
    ...
    maybe_visit::<Atom, _, _>(Atom::definition().dto(), matcher, visitor)
        .or_else(|visitor| {
            maybe_visit::<StAtom, _, _>(StAtom::definition().dto(), matcher, visitor)
        })
        .or_else(|visitor| maybe_visit::<Osmo, _, _>(Osmo::definition().dto(), matcher, visitor))
        .or_else(|visitor| {
            maybe_visit::<StOsmo, _, _>(StOsmo::definition().dto(), matcher, visitor)
        })
        .or_else(|visitor| maybe_visit::<Weth, _, _>(Weth::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Wbtc, _, _>(Wbtc::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Akt, _, _>(Akt::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Axl, _, _>(Axl::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<QAtom, _, _>(QAtom::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Strd, _, _>(Strd::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Inj, _, _>(Inj::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Scrt, _, _>(Scrt::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Stars, _, _>(Stars::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Cro, _, _>(Cro::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Juno, _, _>(Juno::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Tia, _, _>(Tia::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<StTia, _, _>(StTia::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Jkl, _, _>(Jkl::definition().dto(), matcher, visitor))
        .or_else(|visitor| {
            maybe_visit::<MilkTia, _, _>(MilkTia::definition().dto(), matcher, visitor)
        })
        .or_else(|visitor| maybe_visit::<Pica, _, _>(Pica::definition().dto(), matcher, visitor))
        .or_else(|visitor| maybe_visit::<Dym, _, _>(Dym::definition().dto(), matcher, visitor))
        // .or_else(|visitor| maybe_visit::<Cudos, _, _>(Cudos::definition().dto(), matcher, visitor))
}
...
impl InPoolWith<PaymentGroup> for Atom {}
...
impl InPoolWith<PaymentGroup> for StAtom {}
...
impl InPoolWith<PaymentGroup> for Osmo {}
...
impl InPoolWith<PaymentGroup> for StOsmo {}
...
impl InPoolWith<PaymentGroup> for Weth {}
...
impl InPoolWith<PaymentGroup> for Wbtc {}
...
impl InPoolWith<PaymentGroup> for Akt {}
...
impl InPoolWith<PaymentGroup> for Axl {}
...
impl InPoolWith<PaymentGroup> for QAtom {}
...
impl InPoolWith<PaymentGroup> for Strd {}
...
impl InPoolWith<PaymentGroup> for Inj {}
...
impl InPoolWith<PaymentGroup> for Scrt {}
...
impl InPoolWith<PaymentGroup> for Stars {}
...
impl InPoolWith<PaymentGroup> for Cro {}
...
impl InPoolWith<PaymentGroup> for Juno {}
...
impl InPoolWith<PaymentGroup> for Tia {}
...
impl InPoolWith<PaymentGroup> for StTia {}
...
impl InPoolWith<PaymentGroup> for Jkl {}
...
impl InPoolWith<PaymentGroup> for MilkTia {}
...
impl InPoolWith<PaymentGroup> for Pica {}
...
impl InPoolWith<PaymentGroup> for Dym {}
...
//     }
// }
// impl InPoolWith<PaymentGroup> for Cudos {}
