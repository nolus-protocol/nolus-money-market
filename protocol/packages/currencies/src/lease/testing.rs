use currency::{maybe_visit_member, AnyVisitor, Group, Matcher, MaybeAnyVisitResult, MemberOf};
...
{
    maybe_visit_member::<_, definitions::LeaseC1, VisitedG, _>(matcher, visitor)
        .or_else(|visitor| {
            maybe_visit_member::<_, definitions::LeaseC2, VisitedG, _>(matcher, visitor)
        })
        .or_else(|visitor| {
            maybe_visit_member::<_, definitions::LeaseC3, VisitedG, _>(matcher, visitor)
        })
        .or_else(|visitor| {
            maybe_visit_member::<_, definitions::LeaseC4, VisitedG, _>(matcher, visitor)
        })
        .or_else(|visitor| {
            maybe_visit_member::<_, definitions::LeaseC5, VisitedG, _>(matcher, visitor)
        })
        .or_else(|visitor| {
            maybe_visit_member::<_, definitions::LeaseC6, VisitedG, _>(matcher, visitor)
        })
        .or_else(|visitor| {
            maybe_visit_member::<_, definitions::LeaseC7, VisitedG, _>(matcher, visitor)
        })
}
...
pub(crate) mod definitions {
    ...
    use currency::{
        maybe_visit_buddy, CurrencyDTO, CurrencyDef, Definition, InPoolWith, Matcher,
        MaybePairsVisitorResult, PairsGroup, PairsVisitor,
    };
    ...
    pub struct LeaseC1(CurrencyDTO<super::super::Group>);
    ...
    impl PairsGroup for LeaseC1 {
        ...
        {
            maybe_visit_buddy::<LeaseC2, _, _>(matcher, visitor)
                .or_else(|visitor| maybe_visit_buddy::<LeaseC3, _, _>(matcher, visitor))
        }
    }
    ...
    #[serde(deny_unknown_fields, rename_all = "snake_case")]
    #[schemars(crate = "sdk::schemars")]
    pub struct LeaseC2(CurrencyDTO<super::super::Group>);
    ...
    impl PairsGroup for LeaseC2 {
        ...
        where
            ...
            V: PairsVisitor<Pivot = Self>,
        {
            maybe_visit_buddy::<Lpn, _, _>(matcher, visitor)
        }
    }
    ...
    #[serde(deny_unknown_fields, rename_all = "snake_case")]
    #[schemars(crate = "sdk::schemars")]
    pub struct LeaseC3(CurrencyDTO<super::super::Group>);
    ...
    #[serde(deny_unknown_fields, rename_all = "snake_case")]
    #[schemars(crate = "sdk::schemars")]
    pub struct LeaseC4(CurrencyDTO<super::super::Group>);
    ...
    #[serde(deny_unknown_fields, rename_all = "snake_case")]
    #[schemars(crate = "sdk::schemars")]
    pub struct LeaseC5(CurrencyDTO<super::super::Group>);
    ...
    impl PairsGroup for LeaseC5 {
        ...
        where
            ...
            V: PairsVisitor<Pivot = Self>,
        {
            maybe_visit_buddy::<Nls, _, _>(matcher, visitor)
        }
    }
    ...
    #[serde(deny_unknown_fields, rename_all = "snake_case")]
    #[schemars(crate = "sdk::schemars")]
    pub struct LeaseC6(CurrencyDTO<super::super::Group>);
    ...
    #[serde(deny_unknown_fields, rename_all = "snake_case")]
    #[schemars(crate = "sdk::schemars")]
    pub struct LeaseC7(CurrencyDTO<super::super::Group>);
...
mod test {
    ...
    use super::{
        super::Group as LeaseGroup,
        definitions::{LeaseC1, LeaseC2, LeaseC3, LeaseC4, LeaseC5, LeaseC6, LeaseC7},
    };
