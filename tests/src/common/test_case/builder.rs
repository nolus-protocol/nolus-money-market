...
use crate::common::{
    ...
    profit::{Instantiator as ProfitInstantiator, ProfitInstance},
    ...
    Lpn: Currency,
{
    pub fn init_profit(
        ...
        let ProfitInstance {
            ...
            controller,
            drain_vault,
        } = ProfitInstantiator::instantiate(
            &mut test_case.app,
            cadence_hours,
        ...
        let mut address_book = test_case.address_book.with_profit(profit_addr, controller);
        address_book.set_profit_drain_vault(drain_vault);
