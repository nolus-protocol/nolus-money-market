use currency::{
    dex::test::{NativeC, PaymentC3, StableC1},
    Currency,
};
use finance::{
    coin::{Amount, Coin},
...
use lpp::{
    borrow::InterestRate,
    msg::{
        BalanceResponse, ExecuteMsg as ExecuteLpp, PriceResponse, QueryLoanResponse,
        QueryMsg as QueryLpp, QueryQuoteResponse, RewardsResponse, SudoMsg,
    },
    state::Config,
};
