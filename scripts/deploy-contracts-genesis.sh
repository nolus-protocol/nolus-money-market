...
add_wasm_messages() {
  ...
  local -r admin_contract_owner="$6"
  local -r dex_identifier="$7"
  ...
  local -r admin_contract_init_msg='{"contract_owner":"'"$admin_contract_owner"'","contracts":{"platform":{"dispatcher":"'"$REWARDS_DISPATCHER_ADDRESS"'","timealarms":"'"$TIMEALARMS_ADDRESS"'","treasury":"'"$TREASURY_ADDRESS"'"},"protocol":{"'"$dex_identifier"'":{"leaser":"'"$LEASER_ADDRESS"'","lpp":"'"$LPP_ADDRESS"'","oracle":"'"$ORACLE_ADDRESS"'","profit":"'"$PROFIT_ADDRESS"'"}}}}'
