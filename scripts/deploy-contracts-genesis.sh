...
add_wasm_messages() {
  ...
  local -r oracle_init_msg='{"config":{"base_asset":"'$lpp_native'","price_config":{"min_feeders":500,"sample_period_secs":10,"samples_number":12,"discount_factor":750}},"swap_tree":[[0,"USDC"],[[672,"OSMO"],[[1,"ATOM"]],[[722,"EVMOS"]],[[9,"CRO"]],[[604,"STARS"]],[[584,"SCRT"]],[[704,"WETH"]],[[712,"WBTC"]],[[497,"JUNO"]]]]}'
