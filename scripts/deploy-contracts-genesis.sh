...
add_wasm_messages() {
  ...
  local -r admin_contract_init_msg='{"dex_admin":"'"$dex_admin"'","contracts":{"platform":{"dispatcher":"'"$REWARDS_DISPATCHER_ADDRESS"'","timealarms":"'"$TIMEALARMS_ADDRESS"'","treasury":"'"$TREASURY_ADDRESS"'"},"protocol":{"'"$dex_identifier"'":{"leaser":"'"$LEASER_ADDRESS"'","lpp":"'"$LPP_ADDRESS"'","oracle":"'"$ORACLE_ADDRESS"'","profit":"'"$PROFIT_ADDRESS"'"}}}}'
