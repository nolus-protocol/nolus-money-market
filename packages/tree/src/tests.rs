...
fn compare_with_human_readable() {
    let tree: Tree<u32> = from_str(r#"{"nodes":[{"parent":0,"value":5},{"parent":0,"value":4},{"parent":1,"value":6},{"parent":1,"value":7},{"parent":0,"value":3}]}"#).unwrap();

    let human_readable: HumanReadableTree<u32> = from_str(
