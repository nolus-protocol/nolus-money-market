use cosmwasm_std::{Addr, CosmosMsg, DepsMut, Response, StdResult, Storage, SubMsg};
...
impl<'m> PriceHooks<'m> {
    ...
    pub fn check_rules(&self, storage: &mut dyn Storage) {
        // let notifications: Vec<SubMsg> = self
        //     .0
        //     .prefix(())
